...
public class EditTaskActivity extends AppCompatActivity {
    ...
    @InjectView(R.id.btn_editTask) Button _editButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set up all task info
        _taskName.setText(taskName);
        _taskSummary.setText(taskSummary);
        _taskDeadLine.setText(taskDeadLine);
