...
public class AddGroupTest2 {
    ...
    public void addGroupTest() {
        ...
        appCompatEditText3.perform(scrollTo(), replaceText("Test Group 2"), closeSoftKeyboard());

        ViewInteraction appCompatEditText4 = onView(
                withId(R.id.input_groupSummary));
        appCompatEditText4.perform(scrollTo(), replaceText("Long Group Summary: la la la la testing, la la"), closeSoftKeyboard());
