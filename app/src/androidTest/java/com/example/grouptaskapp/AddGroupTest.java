...
public class AddGroupTest {
    ...
    public void addGroupTest() {
        ...
        appCompatEditText3.perform(scrollTo(), replaceText("Test Group"), closeSoftKeyboard());

        ViewInteraction appCompatEditText4 = onView(
                withId(R.id.input_groupSummary));
        appCompatEditText4.perform(scrollTo(), replaceText("testing group details"), closeSoftKeyboard());
